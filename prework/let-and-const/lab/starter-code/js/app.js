...
function displayPics(){
  ...
  // PUT YOUR RESPONSE IN THIS COMMENT because let is scoped to a enclosing code  block. the console log must be inside the code not outside in order t success.
  console.log(viewed);
